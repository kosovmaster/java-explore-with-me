...
(
    ...
    CONSTRAINT fk_comment_to_event FOREIGN KEY (event_id) REFERENCES event (event_id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_comment_to_comment FOREIGN KEY (parent_id) REFERENCES comment (comment_id) ON DELETE CASCADE ON UPDATE CASCADE
);